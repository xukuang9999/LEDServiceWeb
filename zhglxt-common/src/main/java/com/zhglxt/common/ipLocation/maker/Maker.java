...
public class Maker {
    ...
    private void initHeader() throws IOException {
        ...
        // encode the data
        com.zhglxt.common.ipLocation.maker.Util.write(header, 0, VersionNo, 2);
        com.zhglxt.common.ipLocation.maker.Util.write(header, 2, indexPolicy, 2);
        com.zhglxt.common.ipLocation.maker.Util.write(header, 4, System.currentTimeMillis() / 1000, 4);
        com.zhglxt.common.ipLocation.maker.Util.write(header, 8, 0, 4);    // start index ptr
        com.zhglxt.common.ipLocation.maker.Util.write(header, 12, 0, 4);   // end index ptr
    ...
    private void loadSegments() throws Exception {
        ...
        while ((line = br.readLine()) != null) {
            ...
            final long sip = com.zhglxt.common.ipLocation.maker.Util.checkIP(ps[0]);
            final long eip = com.zhglxt.common.ipLocation.maker.Util.checkIP(ps[1]);
            if (sip > eip) {
                br.close();
