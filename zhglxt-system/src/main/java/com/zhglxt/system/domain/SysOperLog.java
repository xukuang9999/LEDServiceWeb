...
public class SysOperLog extends BaseEntity
{
    ...
    @Excel(name = "Business Type", readConverterExp = "0=Other,1=Add,2=Edit,3=Delete,4=Admin,5=Export,6=Import,7=Force Logout,8=Generate Code,9=Clear Data")
    ...
    @Excel(name = "Operator Type", readConverterExp = "0=Other User,1=Backend User,2=Mobile User")
    private Integer operatorType;

    /** 操作人员 */
    @Excel(name = "Operator Name")
    ...
    /** 消耗时间 */
    @Excel(name = "Cost Time", suffix = "Millisecond")
