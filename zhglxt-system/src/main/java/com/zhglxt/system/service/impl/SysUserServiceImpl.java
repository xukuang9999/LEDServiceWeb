...
//        }
    ...
    public void checkUserAllowed(SysUser user)
    {
        ...
        {
            throw new ServiceException("Cannot be allowed to operate super administrator");
        }
    }
    ...
    public void checkUserDataScope(String userId)
    {
        if (!SysUser.isAdmin(ShiroUtils.getUserId()))
        {
            ...
            {
                throw new ServiceException("It's no permission to access user data!");
            }
        }
    }
    ...
    public String importUser(List<SysUser> userList, Boolean isUpdateSupport, String operName)
    {
        ...
        {
            throw new ServiceException("The import user data cannot be empty");
        }
        int successNum = 0;
        int failureNum = 0;
        ...
        for (SysUser user : userList)
        {
            try
            {
                ...
                if (StringUtils.isNull(u))
                {
                    ...
                    successNum++;
                    successMsg.append("<br/>" + successNum + "、account " + user.getLoginName() + " imported successfully");
                }
                else if (isUpdateSupport)
                {
                    ...
                    successNum++;
                    successMsg.append("<br/>" + successNum + "、account " + user.getLoginName() + " updated successfully");
                }
                else
                {
                    failureNum++;
                    failureMsg.append("<br/>" + failureNum + "、account " + user.getLoginName() + " has already existed");
                }
            }
            catch (Exception e)
            {
                ...
                String msg = "<br/>" + failureNum + "、account " + loginName + " failed to import：";
        ...
        if (failureNum > 0)
        {
            failureMsg.insert(0, "Very sorry, failed to import. Total " + failureNum + " data formate aren't correct, errors are following：");
            throw new ServiceException(failureMsg.toString());
        }
        else
        {
            successMsg.insert(0, "Congratulate you, All data succeeded to import! Total " + successNum + " record, The data are following：");
        }
