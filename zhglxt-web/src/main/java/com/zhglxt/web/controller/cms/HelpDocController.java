...
public class HelpDocController extends BaseController {
     ...
     * 新增保存文档
     */
    @Log(title = "Help Doc-Add", businessType = BusinessType.INSERT)
     ...
     * 修改帮助文档
     */
    @Log(title = "Help Doc-Edit", businessType = BusinessType.UPDATE)
     ...
     * 删除文章
     */
    @Log(title = "Help Doc-Delete", businessType = BusinessType.DELETE)
