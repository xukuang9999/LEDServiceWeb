...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            {
                throw new Exception(StringUtils.format("The file name ({}) is illegal， cannot be allowed to download. ", fileName));
            }
    ...
    public void resourceDownload(String resource, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        try
        {
            ...
            {
                throw new Exception(StringUtils.format("The resource file ({}) is illegal, cannot be allowed to download ", resource));
            }
            // 本地资源路径
