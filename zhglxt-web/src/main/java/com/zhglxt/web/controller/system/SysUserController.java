...
public class SysUserController extends BaseController
{
    ...
    @Log(title = "User Manage", businessType = BusinessType.EXPORT)
    ...
    @Log(title = "User Manage", businessType = BusinessType.IMPORT)
     ...
     */
    @RequiresPermissions("system:user:add")
    @Log(title = "User Manage", businessType = BusinessType.INSERT)
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(@Validated SysUser user)
    {
        ...
        {
            return error("Add User '" + user.getLoginName() + "' failed, the login name has already existed");
        }
        else if (StringUtils.isNotEmpty(user.getPhonenumber()) && !userService.checkPhoneUnique(user))
        {
            return error("Add User '" + user.getLoginName() + "' failed, the phone number has already existed");
        }
        else if (StringUtils.isNotEmpty(user.getEmail()) && !userService.checkEmailUnique(user))
        {
            return error("Add user '" + user.getLoginName() + "' failed, the email has already existed");
        }
     ...
     */
    @RequiresPermissions("system:user:edit")
    @Log(title = "User Manage", businessType = BusinessType.UPDATE)
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(@Validated SysUser user)
    {
        ...
        if (!userService.checkLoginNameUnique(user))
        {
            return error("Edit user '" + user.getLoginName() + "' failed, the login name has already existed");
        }
        else if (StringUtils.isNotEmpty(user.getPhonenumber()) && !userService.checkPhoneUnique(user))
        {
            return error("Edit user '" + user.getLoginName() + "' failed, the phone number has already existed");
        }
        else if (StringUtils.isNotEmpty(user.getEmail()) && !userService.checkEmailUnique(user))
        {
            return error("Edit user '" + user.getLoginName() + "' failed, the email has already existed");
        }
     ...
     */
    @RequiresPermissions("system:user:edit")
    @Log(title = "User Manage", businessType = BusinessType.GRANT)
    ...
    @Log(title = "User Manage", businessType = BusinessType.DELETE)
    @PostMapping("/remove")
    @ResponseBody
    public AjaxResult remove(String ids)
    {
        ...
        {
            return error("The current user cannot be allowed to delete");
        }
