    ...
    $.extend({
        ...
        table: {
            ...
            exportExcel: function(formId) {
                table.set();
                $.modal.confirm("Do you confirm to export all " + table.options.modalName + "？", function() {
                ...
                top.layer.open({
                    ...
                    btn1: function(index, layero){
                        ...
                        if (file == '' || (!$.common.endWith(file, '.xls') && !$.common.endWith(file, '.xlsx'))) {
                            $.modal.msgWarning("please select the extension of .xls or .xlsx file");
                            return false;
                        }
        ...
        operate: {
            ...
            remove: function(id) {
                table.set();
                $.modal.confirm("Do you confirm to delete " + table.options.modalName + "？", function() {
            ...
            removeAll: function() {
                ...
                $.modal.confirm("Do you confirm to delete selected " + rows.length + " records?", function() {
            ...
            clean: function() {
                table.set();
                $.modal.confirm("Do you confirm to clear " + table.options.modalName + "？", function() {
            ...
            editFull: function(id) {
                ...
                $.modal.openFull("Edit " + table.options.modalName, url);
            },
            // 修改访问地址
            editUrl: function(id) {
                var url = "/404.html";
            ...
            view: function(id){
                ...
                $.modal.popupRight(table.options.modalName + " information detail", url);
            },
            // 保存信息 刷新表格
        ...
        tree: {
            ...
            notAllowParents: function(_tree) {
                ...
                if (nodes.length == 0){
                    $.modal.msgError("Please select node before being submitted");
                    return false;
                }
                for (var i = 0; i < nodes.length; i++) {
                    if (nodes[i].level == 0) {
                        $.modal.msgError("The root node cannot be selected （" + nodes[i].name + "）");
                        return false;
                    }
                    if (nodes[i].isParent) {
                        $.modal.msgError("The parent node cannot be selected（" + nodes[i].name + "）");
                        return false;
                    }
                }
                return true;
            ...
            notAllowLastLevel: function(_tree) {
                ...
                for (var i = 0; i < nodes.length; i++) {
                    if (!nodes[i].isParent) {
                        $.modal.msgError("The last level node cannot be selected（" + nodes[i].name + "）");
                        return false;
                    }
                }
                return true;
